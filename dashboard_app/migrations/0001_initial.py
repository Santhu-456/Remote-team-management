# Generated by Django 5.2.6 on 2025-11-19 09:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='dashboard_app.project')),
            ],
            options={
                'ordering': ['-created_at'],
            },
